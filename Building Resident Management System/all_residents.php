    ...
    <div id="content">
      ...
      <p>
        ...
        if (isset($_GET['p']) && is_numeric ($_GET['p'])) {//already been calculated
          ...
          $q = "SELECT COUNT(ResidentID) FROM Residents";
        ...
        // Make the query:
        $q = "SELECT ResidentID, BuildingID, FirstName, LastName, Email, PhoneNumber, ApartNum, ResType, BillingAddress, EmerContactInfo, Edit, Del FROM Residents ORDER BY BuildingID ASC LIMIT $start, $pagerows";
